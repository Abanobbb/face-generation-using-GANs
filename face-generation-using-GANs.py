...
# 
# Most generated samples look like faces of real people; they are just quite blur and some photos are a little bit weird because they miss some part of their faces
# 
# more variety of faces might help to train neural network better and generate a new type of faces.
# 
# In order to improve the model,I think I need to extend the image size to 128x128 or 256x256, together with more CNN layers and more feature maps so the model can generated much better and clearer samples when training with more epochs.
# 
# we need to diversify the dataset. We need to add more non-white celebrities. Also, it will probably help if we normalize background(say, make it white for all faces) and train for more epochs.
# 
# 
# 
# 
